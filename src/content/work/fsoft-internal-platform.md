...
## Role
**Platform Engineer TechLead** at FPT Software

## Duration
2023 - 2024

## Overview
Led a team of 5 engineers to build a cloud infrastructure self-service platform for FPT Software's internal IdP, enabling developers to provision cloud resources through a GitOps workflow.
...
## Technologies
- **IaC Engine**: KubeVela (customized)
